    ...
    <div className="relative flex min-h-screen items-center justify-center bg-zinc-950 px-4 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md space-y-8 rounded-2xl border border-zinc-800/80 bg-zinc-900/50 p-8 md:p-10 shadow-2xl backdrop-blur-md shadow-black/80">
        <div className="flex flex-col items-center text-center">
          <div className="mb-5 flex h-14 w-14 items-center justify-center overflow-hidden rounded-xl border border-zinc-800 bg-zinc-950 shadow-inner">
            <img
        ...
        <div className="mt-8">
          <button
            ...
            className="group relative flex w-full justify-center rounded-full bg-white px-4 py-3 text-sm font-semibold text-zinc-950 no-underline transition hover:bg-zinc-200 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-40"
          >
